...
- **Atomic abstraction:** Shifting the fundamental unit from qubits to context-based addressing eliminates common indexing issues and enforces physical semantics.
